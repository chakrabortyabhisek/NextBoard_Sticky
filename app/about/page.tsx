      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="text-3xl font-extrabold text-gray-900 mb-6">
              What is NextBoard_Sticky?
            </h2>
            <div className="prose prose-teal prose-lg">
              <p>
                NextBoard_Sticky is a visual workspace that helps you organize your ideas
              ...
              <p>
                ...
                organizing your thoughts, NextBoard_Sticky gives you the tools to think
        ...
        <div className="mt-16">
          ...
          <div className="max-w-3xl mx-auto">
            <FAQItem
              question="Is NextBoard_Sticky free to use?"
              answer={
                <p>
                  Yes, NextBoard_Sticky is currently free to use during our beta period.
            ...
            <FAQItem
              ...
              answer={
                <p>
                  ...
                  dashboard or by emailing support@nextboard-sticky.com.
                </p>
              }
            />
          </div>
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-teal-50 rounded-lg px-6 py-12 text-center">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm text-gray-500">
                © 2023 NextBoard_Sticky. All rights reserved.
              </span>
            </div>
