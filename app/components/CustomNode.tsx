...
function CustomNode({ id, data, selected }: NodeProps<CustomNodeData>) {
  ...
  return (
    <div
      ...
      className={`bg-white ${
        isEditing
          ? "shadow-md ring-1 ring-teal-200"
          : selected
          ? "shadow-md"
          : "shadow-sm"
      ...
      <div className="absolute right-0 top-1/2 transform -translate-y-1/2 z-50">
        <div className="relative group">
          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1 flex items-center justify-center">
            <div className="w-2 h-2 rounded-full bg-teal-400 absolute opacity-30"></div>
          ...
          <Handle
            ...
            id="right"
            className="w-6 h-6 rounded-full bg-teal-400 opacity-30 hover:opacity-70 transition-opacity"
