      ...
      {isEditing ? (
        <div className="p-3 space-y-3">
          <div className="flex items-center">
            <LinkIcon className="h-4 w-4 text-teal-500 mr-2 flex-shrink-0" />
            <input
              type="text"
              value={content}
              onChange={(e) => {
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-full text-xs text-teal-600 bg-transparent focus:outline-none"
              autoFocus
            />
          </div>
          <div className="flex justify-end">
            <button
              ...
              className="text-xs bg-teal-500 hover:bg-teal-600 text-white px-3 py-1 rounded transition-colors duration-200"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center mt-2 space-x-2">
                      <a
                        ...
                        className="text-xs text-teal-500 hover:text-teal-600 flex items-center transition-colors duration-200"
