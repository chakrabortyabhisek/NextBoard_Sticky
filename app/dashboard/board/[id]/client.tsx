            ...
            <div className="flex justify-between items-center h-12">
              ...
              <div className="flex items-center space-x-3">
                ...
                {session?.user?.image ? (
                  ...
                  <div className="h-6 w-6 rounded-full bg-teal-600 flex items-center justify-center text-white text-xs">
                    {session?.user?.name
          ...
          >
            ...
            {showHelperText && (
              <Panel
                ...
                className="hidden md:block bg-teal-500/80 backdrop-blur-sm p-3 rounded-md shadow-md mb-4 text-xs text-white font-medium transition-opacity duration-300"
              >
